...
const translations = {
  en: {
    ...
    'Active students participating in our programs': 'Active students participating in our programs',
    'Staff working together': 'Staff working together',
    ...
    'Student rights advocacy': 'Student rights advocacy',
    'Campus policy studies': 'Campus policy studies',
    'Strategic issue analysis': 'Strategic issue analysis',
    'Recommendation development': 'Recommendation development',
    'Conflict mediation': 'Conflict mediation',
    'Student data collection': 'Student data collection',
    'Campus trend analysis': 'Campus trend analysis',
  ...
  id: {
    ...
    'Active students participating in our programs': 'Mahasiswa aktif berpartisipasi dalam program kami',
    'Staff working together': 'Staff bekerja sama',
    ...
    // Ministry Responsibilities (Indonesian)
    'Organization structure management': 'Manajemen struktur organisasi',
    'Internal communication': 'Komunikasi internal',
    'Member coordination': 'Koordinasi anggota',
    'Policy implementation': 'Implementasi kebijakan',
    'Resource allocation': 'Alokasi sumber daya',
    'External partnerships': 'Kemitraan eksternal',
    'Public relations': 'Hubungan masyarakat',
    'Community engagement': 'Keterlibatan komunitas',
    'Collaborative projects': 'Proyek kolaboratif',
    'Brand representation': 'Representasi merek',
    'Social media management': 'Manajemen media sosial',
    'Content creation': 'Pembuatan konten',
    'Event coverage': 'Liputan acara',
    'Graphic design': 'Desain grafis',
    'Public announcements': 'Pengumuman publik',
    'Student advocacy': 'Advokasi mahasiswa',
    'Scholarship information': 'Informasi beasiswa',
    'Rights protection': 'Perlindungan hak',
    'Wellness programs': 'Program kesejahteraan',
    'Support services': 'Layanan dukungan',
    'Cultural events': 'Acara budaya',
    'Art exhibitions': 'Pameran seni',
    'Traditional performances': 'Pertunjukan tradisional',
    'Creative workshops': 'Workshop kreatif',
    'Talent development': 'Pengembangan bakat',
    'Study groups': 'Kelompok belajar',
    'Academic competitions': 'Kompetisi akademik',
    'Learning resources': 'Sumber belajar',
    'Educational workshops': 'Workshop pendidikan',
    'Research promotion': 'Promosi penelitian',
    'Student rights advocacy': 'Advokasi hak mahasiswa',
    'Campus policy studies': 'Studi kebijakan kampus',
    'Strategic issue analysis': 'Analisis isu strategis',
    'Recommendation development': 'Pengembangan rekomendasi',
    'Conflict mediation': 'Mediasi konflik',
    'Student data collection': 'Pengumpulan data mahasiswa',
    'Campus trend analysis': 'Analisis tren kampus',
    'Data visualization': 'Visualisasi data',
    'Statistical reporting': 'Pelaporan statistik',
